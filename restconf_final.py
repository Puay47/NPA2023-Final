...
def create():
    ...
    resp = requests.put(
        "https://10.0.15.189/restconf/data/ietf-interfaces:interfaces/interface=Loopback65070031",
...
def status():
    api_url_status = "https://10.0.15.189/restconf/data/ietf-interfaces:interfaces-state/interface=Loopback65070031"
